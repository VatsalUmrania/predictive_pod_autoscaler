...
def convert_model(model_path="model/artifacts/ppa_model.keras", quantize=True, output_path=None, validation_data=None):
    ...
    if baseline_mae is not None and validation_data is not None:
        try:
            ...
            accuracy_loss_pct = ((quantized_mae - baseline_mae) / baseline_mae * 100) if baseline_mae > 0 else 0.0
