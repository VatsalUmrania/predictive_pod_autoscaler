...
from ppa.common.constants import CAPACITY_PER_POD, GAP_THRESHOLD_MINUTES  # noqa: E402
from ppa.common.feature_spec import (  # noqa: E402
    FEATURE_COLUMNS,
    NUM_FEATURES,
    QUERIED_FEATURES,
    TARGET_COLUMNS,
...
from ppa.common.promql import LATENCY_WINDOW, RATE_WINDOW, build_queries  # noqa: E402
...
class TestPromQL:
    def test_build_queries_returns_all_queried_features(self):
        ...
        raw_query_keys = set(QUERIED_FEATURES) - {
            "rps_per_replica",
            "replicas_normalized",
        } | {
            "requests_per_second",
    ...
    def test_queries_are_namespace_scoped(self):
        ...
        for name, query in queries.items():
            assert (
                'namespace="production"' in query
            ), f"Query {name} is not namespace-scoped"
    ...
    def test_memory_uses_avg(self):
        query = build_queries("test-app", "default", "test-app")[
