...
from cli.config import DEFAULT_NAMESPACE, DEPLOY_DIR, PROJECT_DIR
from cli.utils import console, error, info, kubectl, run_cmd, success
...
def onboard(
    ctx: typer.Context,
    app_name: str = typer.Option(..., "--app-name", "-a", help="Logical application name (used for /models/{app})."),
    ...
    console.print()
    console.print(Panel(config_table, title="[bold bright_cyan]Onboard Application[/]", border_style="bright_cyan"))
